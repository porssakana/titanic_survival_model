...
sum_age = 0
for value in passengers['Age'].values:
    if np.isnan(value) == True:
        continue
    else:
        sum_age += value
mean_age = sum_age / len(passengers['Age'].values)
...
# Score the model on the train data and print accuracy
print(model.score(train_features, train_labels))

# Score the model on the test data and print accuracy
